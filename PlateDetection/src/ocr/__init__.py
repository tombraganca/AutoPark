...
def validate_ocr(img):
    orc_results = reader.readtext(img, allowlist ='ABCDEFGHIJKLMNOQPRSTUVXYZ0123456789-')
    ...
    for result in orc_results:
        ...
        if test == None:
            try:
                ...
                ocrNumber = reader.readtext(img, allowlist ='0123456789')
