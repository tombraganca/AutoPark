...
class VehicleRepositoryImp implements VehicleRepository {
  ...
  @override
  Future<Either<Failure, bool>> addVehicle(bool isUpdate, String marca,
      String modelo, String placa, String token) async {
    try {
      return Right(await _vehicleDataSource.addVehicle(
